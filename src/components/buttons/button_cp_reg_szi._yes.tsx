...
function CpRegSziYesButton() {
  ...
  const onclick = (e: any) => {
    ...
    setItemToLocalStorage('cp_reg_szi', true)
    history("/cp_szi/", { state: newAnswer });

    // window.location.assign('http://localhost:3001/how_to_fill/');
  }

  return (
    <div className="cb-quiz" onClick={(e) => onclick(e)}>
...
export default CpRegSziYesButton;