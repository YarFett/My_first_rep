...
function CpMarkTrust() {
    const history = useNavigate();

    const onclickYes = (e: any) => {
        setItemToLocalStorage('cp_mark_trust', true)
        history("/trust_mark/", {});

    }
    const onclickNo = (e: any) => {
        setItemToLocalStorage('cp_mark_trust', false)
        history("/cp_mark_po/", {});
                ...
                <div className="order-request__container">
                    <div className="constructor">
                        <header className="constructor__header">
                            ...
                            {/* <a href="" className="constructor__link-back"><Link to={"/dev_gost"}>Назад</Link></a> */}
                            <p className="constructor__title">ЦП проходил оценку уровня доверия?</p>
                        </header>
