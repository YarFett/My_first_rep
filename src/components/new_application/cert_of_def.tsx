...
function CertOfDef(){
    ...
    const onclickYes = (e:any) => {
        const newAnswer= {
          ...
          setItemToLocalStorage('certification', true)
          history("/cert_fstek/", {});
    ...
    const onclickNo = (e:any) => {
        const newAnswer= {
          ...
          setAnswer((prevAnswers: any) =>[...prevAnswers, newAnswer]);
          setItemToLocalStorage('certification', false)
          history("/ib_info/", {});
    ...
    return(
        ...
        <header className="constructor__header">
            <Link className="constructor__link-back" to={"/cp_info"}>Назад</Link>
            <p className="constructor__title">Является ли продукт средством защиты информации?</p>
        </header>
        <div className="constructor__inner">
            <div id="CertOfDefYesClick" className="cb-quiz" onClick={onclickYes}>
            ...
            <div className="cb-quiz" onClick={onclickNo}>
