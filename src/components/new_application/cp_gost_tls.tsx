...
function CpGostTls(){
    ...
    const onclickYes = (e: any) => {
        setItemToLocalStorage('cp_gost_tls', true)
        history("/cp_true_connect/", {});

    }
    const onclickNo = (e: any) => {
        setItemToLocalStorage('cp_gost_tls', false)
        history("/cp_true_connect/", {});

    }

    const onclickNotApp = (e: any) => {
        setItemToLocalStorage('cp_gost_tls', null)
        history("/cp_true_connect/", {});
    ...
    return(
        ...
        <div className="constructor">
            <header className="constructor__header">
                ...
                {/* <a href="" className="constructor__link-back"><Link to={"/cp_gost_vpn"}>Назад</Link></a> */}
                <p className="constructor__title">ЦП соответствует ГОСТ-TLS для веб-консоли и API?</p>
            </header>
