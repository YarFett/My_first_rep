...
function CpHarModal(props: any) {
    ...
    const [description, setDiscription] = useState(getItemFromLocalStorage('description'))
    const [file, setFile] = useState<File>();

    const handleInputDiscription = (e: { target: { value: React.SetStateAction<string>; }; }) => {
                            ...
                            <div className="constructor__card-row">
                                <div className="cb-textarea">
                                    ...
                                    <div className="cb-textarea__field">
                                        <textarea className="cb-textarea__input" value={description} onChange={handleInputDiscription}></textarea>
